 ...
 */
@interface OMIDPubmaticAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDPubmaticPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDPubmaticPartner *)partner
                               ...
                               resources:(NSArray<OMIDPubmaticVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
