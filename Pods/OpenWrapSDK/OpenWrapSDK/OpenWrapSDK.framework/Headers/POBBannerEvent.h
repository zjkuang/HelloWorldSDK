...
/*!
 ...
 Deprecated: openWrapPartnerDidWin is deprecated. Recomended to use openWrapPartnerDidWinForBid.
 */
- (void)openWrapPartnerDidWin __attribute__((deprecated("openWrapPartnerDidWin is deprecated from OW SDK v1.7.0 onwards. Use openWrapPartnerDidWinForBid:bidId instead")));
